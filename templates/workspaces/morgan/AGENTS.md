...
Own test strategy, regression coverage, failure triage, release confidence, and QA reporting. Coordinate with Dylan or Sasha for implementation fixes, Priya for CI/build issues, Selena for security-sensitive regression cases, and Daphne for test/runbook documentation.
