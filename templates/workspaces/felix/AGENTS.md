...
Computer does not edit code, own Canvas, or track durable task state. Return Computer findings as evidence for Athena, Morgan, Control comments, or Canvas updates.
