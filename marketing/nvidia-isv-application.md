...
- Two tiers: **Starter** (free, 10 agents) and **Pro** ($49 one-time, full 28-agent suite) + optional **Cloud Add-on** ($20/mo, requires Pro)
...
2. **Startups** — Small teams that need leverage. A.L.I.C.E. Pro ($49 one-time) gives a 2-person startup the operational bandwidth of a larger team: marketing copy, investor research, DevOps scripts, and legal summaries — all from a single CLI.
...
| Pricing tiers | Starter (free, 10 agents) / Pro ($49 one-time, 28 agents) / Cloud Add-on ($20/mo, requires Pro) |
...
Starter tier is free (10 agents). Pro is $49 one-time (full 28-agent suite). Cloud Add-on is $20/mo (requires Pro).
