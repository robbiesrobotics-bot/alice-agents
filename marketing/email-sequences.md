...
When you're ready to unlock the full 28-agent roster and persistent memory, Pro is $49 one-time — no subscription, no recurring charges. The Cloud Add-on ($20/mo) adds hosted Mission Control if you want it later.
...
**Pro is $49 one-time.** No subscription. Pay once, own it forever.
